...
func TestRunFlags(t *testing.T) {
	...
	assert.Equal(t, map[string]string{"net": "none", "e": "FOO=BAR"}, f.Values())
...
func TestRunFlags2(t *testing.T) {
	...
	assert.Equal(t, map[string]string{"-rm": "", "-name": "%p-%i", "-net": "none", "e": "SERVER=wss://registry.colofoo.net", "v": "/lib64:/lib64:ro"}, f.Values())
